...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create rent-hotel
  fly apps create rent-hotel-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app rent-hotel
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app rent-hotel-staging
  ```
...
- Create a persistent volume for the sqlite database for both your staging and
  ...
  ```sh
  fly volumes create data --size 1 --app rent-hotel
  fly volumes create data --size 1 --app rent-hotel-staging
  ```
